...
public class QueryUtils {
    ...
    private static List<News> extractResultsFromJson(String newsJSON) {
        ...
        try {
            ...
            // Create a JSONObject that has all the information
            ...
            // For each news articles in the resultsArray, create a {@link News} object
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                // Create a new {@link News} object with the sectionName, webPublicationDate, webTitle,
            ...
            Log.e("QueryUtils", "Problem parsing the newsObj JSON results", e);
        }
